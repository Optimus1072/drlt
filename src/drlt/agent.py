...
class Agent(BaseModel):
  ...
  def build_dqn(self):
    ...
    with tf.variable_scope('prediction'):
		...
		# input, representing the current screen x history length. TODO change to android state
	  ...
	  # output q_action is the action with the maximum q value
